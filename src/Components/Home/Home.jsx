    ...
    <>
      <div className="home_container">
          ...
          <div className="hero_container">
            ...
            <div className="hero_text_3">
              ...
              <div className="hero_text_3_2">
                <p> <a href="mailto:rr710505@gmail.com?subject=Inquiry%20About%20Your%20Service&body=Hello,%0D%0A%0D%0AI'm reaching out to inquire about your services. Please provide me with more information.%0D%0A%0D%0AThank you." target="_blank" rel="noopener noreferrer" style={{textDecoration:"none",color:"#F08D8D"}}>Email me</a> </p>
                <hr />
              </div>
            </div>
          </div>
        ...
        <div className="top_right">
          <img className="top_right_img" src={brand} alt="brand_img" loading="lazy"/>
        </div>
      </div>
      <Bio />
      <Work />
